...
class AuthMessagesAr extends AuthMessages {
  ...
  /// ```dart
  /// "لقد أرسلنا رمز التحقق إلى {email}. أدخل الرمز للمتابعة."
  /// ```
  String get code_sent_to_email => """لقد أرسلنا رمز التحقق إلى {email}. أدخل الرمز للمتابعة.""";

  /// ```dart
  /// "يجب أن يصل الرمز خلال دقائق. تحقق من مجلد البريد العشوائي إذا لم تجده."
  /// ```
  String get code_check_spam => """يجب أن يصل الرمز خلال دقائق. تحقق من مجلد البريد العشوائي إذا لم تجده.""";
  ...
  /// ```
  String get code_resent => """تم إعادة إرسال رمز التحقق إلى {email}""";
  ...
  /// ```dart
  /// "تم التحقق من هويتك. قم بتعيين كلمة مرور جديدة لـ {email}."
  /// ```
  String get verified_set_password => """تم التحقق من هويتك. قم بتعيين كلمة مرور جديدة لـ {email}.""";
...
Map<String, String> get messagesArMap => {
  ...
  """auth.guest""": """الاستمرار كزائر""",
      ...
      """auth.code_sent_to_email""": """لقد أرسلنا رمز التحقق إلى {email}. أدخل الرمز للمتابعة.""",
      """auth.code_check_spam""": """يجب أن يصل الرمز خلال دقائق. تحقق من مجلد البريد العشوائي إذا لم تجده.""",
      ...
      """auth.code_resent""": """تم إعادة إرسال رمز التحقق إلى {email}""",
      """auth.resend_code""": """إعادة إرسال الرمز""",
      """auth.back""": """رجوع""",
      """auth.create_new_password""": """إنشاء كلمة مرور جديدة""",
      """auth.verified_set_password""": """تم التحقق من هويتك. قم بتعيين كلمة مرور جديدة لـ {email}.""",
