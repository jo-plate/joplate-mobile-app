...
class AuthMessages {
  ...
  /// ```
  String get code_sent_to_email => """We sent a verification code to {email}. Enter the code to continue.""";
  ...
  /// ```
  String get code_resent => """Verification code resent to {email}""";
  ...
  /// ```dart
  /// "Your identity has been verified. Set your new password for {email}."
  /// ```
  String get verified_set_password => """Your identity has been verified. Set your new password for {email}.""";
...
Map<String, String> get messagesMap => {
  ...
  """common.following""": """Following""",
      ...
      """auth.code_sent_to_email""": """We sent a verification code to {email}. Enter the code to continue.""",
      ...
      """auth.verified_set_password""": """Your identity has been verified. Set your new password for {email}.""",
